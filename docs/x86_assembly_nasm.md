...
Another project I want to do after learning the basics of `Assembly` is to redo my [Libft](https://github.com/jotavare/libft)[^postfix] and convert all functions from `C` to `x86 Assembly`, or at least try to.
